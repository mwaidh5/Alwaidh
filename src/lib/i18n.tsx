...
const AR: Record<string, string> = {
  ...
  'Computers & cameras': 'الحاسبات والكاميرات',
  ...
  'This erases your account and your profile for good. Orders already placed stay with the shop as business records.':
    'هذا يحذف حسابك وملفك الشخصي نهائياً. الطلبات اللي سويتها تبقى عند المحل كسجلات تجارية.',
  'Type DELETE to confirm': 'اكتب DELETE للتأكيد',
  'Enter your password to confirm': 'اكتب كلمة المرور للتأكيد',
  'Delete account for good': 'احذف الحساب نهائياً',
  'Your account has been deleted.': 'تم حذف حسابك.',
  'Could not delete the account.': 'ما تم حذف الحساب.',
  ...
  'Who added or changed what, and when.': 'منو أضاف أو غيّر شنو، ومتى.',
  'Search product, person or field': 'ابحث بالمنتج أو الشخص أو الحقل',
  'Nothing recorded yet.': 'ماكو شي مسجل بعد.',
  'Edited': 'تعديل',
  'Trashed': 'نقل للمحذوفات',
  'Restored': 'استرجاع',
  ...
  'Extra batteries': 'بطاريات إضافية',
  'extra battery': 'بطارية إضافية',
  'Each adds {kwh} KWh and about {hours} more hours, for {price} IQD.': 'كل بطارية تضيف {kwh} KWh وحوالي {hours} ساعة تغذية إضافية، مقابل {price} دينار.',
  'Extra {kwh} KWh battery: {price} IQD, about {hours} more backup hours.': 'بطارية إضافية {kwh} KWh: {price} دينار، تزيد التغذية حوالي {hours} ساعة.',
  'hours': 'ساعة',
  'monthly': 'شهرياً',
  ...
  'Thinking about cameras for your home or shop?': 'تفكر بكاميرات مراقبة لبيتك أو محلك؟',
  'See our camera prices, or ask us anything — the site survey is free.': 'اطلع على أسعار الكاميرات، أو اسألنا أي شيء — الكشف على الموقع مجاني.',
  'See camera prices': 'اطّلع على أسعار الكاميرات',
  'Looking for a laptop or desktop that lasts?': 'تدور على لابتوب أو كمبيوتر يدوم؟',
  'See our computers, or ask us which one fits your work.': 'اطلع على أجهزتنا، أو اسألنا أي جهاز يناسب شغلك.',
  'See computer prices': 'اطّلع على أسعار الكمبيوترات',
  ...
  'Type to search products.': 'اكتب للبحث عن المنتجات.',
  'Manage your profile, security, and see your orders.': 'إدارة ملفك الشخصي والأمان وعرض طلباتك.',
  'Profile': 'الملف الشخصي',
  'Change photo': 'تغيير الصورة',
  'JPG or PNG · max 5 MB': 'JPG أو PNG · بحد أقصى 5 ميغابايت',
  'Display name': 'الاسم الظاهر',
  'Save profile': 'حفظ الملف',
  'Profile photo updated.': 'تم تحديث صورة الملف.',
  'Profile updated.': 'تم تحديث الملف.',
  'Email verified': 'البريد الإلكتروني موثّق',
  "Your email isn't verified yet.": 'بريدك الإلكتروني غير موثّق بعد.',
  'Some features (like staff access) only work with a verified email.': 'بعض الميزات (مثل وصول الموظفين) تعمل فقط مع بريد موثّق.',
  'Verify now — send email': 'وثّق الآن — أرسل البريد',
  "I've clicked the link — check again": 'ضغطت على الرابط — تحقق مجدداً',
  'Checking…': 'جارٍ التحقق…',
  'Current password': 'كلمة المرور الحالية',
  'New password (min 6 characters)': 'كلمة المرور الجديدة (6 أحرف على الأقل)',
  'Change password': 'تغيير كلمة المرور',
  'Changing…': 'جارٍ التغيير…',
  'Forgot it? Email me a reset link': 'نسيتها؟ أرسل لي رابط إعادة التعيين',
  'Password changed.': 'تم تغيير كلمة المرور.',
  'You sign in with Google, so your password is managed by your Google account — there is no separate password for this site.': 'تسجّل دخولك عبر Google، لذا كلمة مرورك تُدار من حساب Google — لا توجد كلمة مرور منفصلة لهذا الموقع.',
  'My orders': 'طلباتي',
  'total': 'إجمالاً',
  'No orders yet.': 'لا توجد طلبات بعد.',
  'Orders you place while signed in will show up here.': 'الطلبات التي تنشئها وأنت مسجّل الدخول ستظهر هنا.',
  ...
  'Your area': 'منطقتك',
  'Register and we will contact you': 'سجّل ونتصل بيك',
  'Solar system with a 5-year warranty · Baghdad and all provinces': 'منظومة شمسية مع ضمان 5 سنوات · بغداد وكل المحافظات',
