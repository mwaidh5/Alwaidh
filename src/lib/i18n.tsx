...
const AR: Record<string, string> = {
  ...
  'Chat': 'دردشة',
  'Login': 'دخول',
  'Leads and customers — drag a card as the conversation moves.': 'العملاء المحتملون والزبائن — اسحب البطاقة مع تقدّم المحادثة.',
  'Add contact': 'إضافة جهة اتصال',
  'Edit contact': 'تعديل جهة الاتصال',
  'Search name, phone, notes…': 'ابحث بالاسم أو الهاتف أو الملاحظات…',
  ...
  'Lost': 'خسارة',
  'Call': 'اتصال',
  'Nothing written yet — the first call goes here.': 'لا شيء مكتوب بعد — أول مكالمة تُسجّل هنا.',
  'Write what happened…': 'اكتب ما حدث…',
  'Add': 'إضافة',
  'Book': 'الدفتر',
  'Area / address': 'المنطقة / العنوان',
  'Interested in': 'مهتم بـ',
  'e.g. Baghdad, Mansour': 'مثال: بغداد، المنصور',
  'e.g. 8kW hybrid system': 'مثال: منظومة هجينة 8 كيلو واط',
  'No contacts here yet.': 'لا توجد جهات اتصال هنا بعد.',
  'The CRM has not been opened for your account yet — ask the admin.': 'لم يُفتح نظام إدارة العملاء لحسابك بعد — اطلب من المدير.',
  'Facebook': 'فيسبوك',
  'Instagram': 'انستغرام',
  'WhatsApp': 'واتساب',
